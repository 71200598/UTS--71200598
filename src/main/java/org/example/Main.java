...
public class Main {
    public static void main(String[] args) {
        ...
        Truck truckHino = new Truck(dieselEngine, manualTransmision, trailTire,
                truckWheel, 4500);
        ...
        System.out.println("Tipe transmisi: "+
                truckHino.getTransmition().getTransType());
        System.out.println("Tipe Ban : "+ truckHino.getTire().getTireType());
        System.out.println("Diameter Roda : R"+
                truckHino.getWheel().getDiameter());
    }
}
